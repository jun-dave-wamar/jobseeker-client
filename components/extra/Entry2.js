            ...
            <SafeAreaView style={{ flex: 1, paddingTop: StatusBar.currentHeight, backgroundColor: '#282C34', paddingHorizontal: 25 }}>
                ...
                <View style={{ justifyContent: 'center', alignContent: 'center', alignItems: 'center', flex: 1 }}>
                    <View style={{ justifyContent: 'center', alignContent: 'center', alignItems: 'center' }}>
                        ...
                        <Text style={{ fontSize: 20, color: '#fff', fontFamily: 'Poppins-Regular', textAlign: 'center' }}>Browse candidates list</Text>
                        <Text style={{ fontSize: 15, color: '#fff', fontFamily: 'Poppins-Regular', textAlign: 'center' }}>Our candidates list include several  industries, so you can find the best job for you.</Text>
