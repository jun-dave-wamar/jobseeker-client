      ...
      <SafeAreaView style={{ flex: 1 }}>
        ...
        <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
          <View style={styles.inner}>
            <View style={{ height: 300, position: 'relative', resizeMode: 'contain' }}>
              <View
                style={{
                  position: 'absolute',
                  top: 0,
                ...
                <Image style={{width: '150%', height: '100%', resizeMode: 'contain'}} source={require('../../assets/images/topContent.png')} />
              </View>
              <View style={{ position: 'absolute', left: -220, bottom: -50, zIndex: 9999 }}>
                <Image
                style={{width:408.51, height:360.86, resizeMode: 'cover' }}
                  source={require('../../assets/images/leftBg.png')}
                />
              </View>
            </View>
